...
This program takes an audio file as input and uses machine learning algorithms to classify it into one of several predefined music genres. The program extracts various features from the audio file, such as MFCC coefficients and spectral features, and uses them as inputs to a machine learning model. The model has been trained on a large dataset of audio files from different genres, and can accurately classify new audio files into one of the following genres: classical, jazz, rock, and pop.
...
Dont use python and no more than 150 lines of code
```